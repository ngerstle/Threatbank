	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'Id',
				_1: _elm_lang$core$Json_Encode$int(threat.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'Title',
					_1: _elm_lang$core$Json_Encode$string(threat.title)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'Description',
						_1: _elm_lang$core$Json_Encode$string(threat.description)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'Remediation',
							_1: _elm_lang$core$Json_Encode$string(threat.remediation)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'Selected',
										_1: _elm_lang$core$Json_Encode$bool(threat.selected)
									},
									_1: {ctor: '[]'}
								}
							}
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'threats',
				_1: _elm_lang$core$Json_Encode$list(threatsjson)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'status',
					_1: _elm_lang$core$Json_Encode$string(model.status)
				},
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Types$ResetSelections = {ctor: 'ResetSelections'};
...
var _user$project$Rest$decodeRequestJson = F2(
	function (model, rawjson) {
...
var _user$project$View$cssThreatCardCheckbox = 'mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect';
var _user$project$View$cssThreatCardTop = 'mdl-card__title mdl-card--expand';
var _user$project$View$cssThreatCard = 'demo-card-event mdl-card mdl-shadow--2dp';
var _user$project$View$cssThreatRow = 'ThreatRow';
var _user$project$View$cssThreatId = 'ThreatID';
var _user$project$View$cssThreatFields = 'ThreatFields';
var _user$project$View$cssThreatButton = 'DeleteThreatButton';
var _user$project$View$onBlurWithTargetValue = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'blur',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$targetValue));
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_(sfieldname),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(text),
									_1: {
										ctor: '::',
										_0: _user$project$View$onBlurWithTargetValue(msg),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_user$project$View$cssThreatCard),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(_user$project$View$cssThreatCardTop),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(_user$project$View$cssThreatCardCheckbox),
											_1: {
												ctor: '::',
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class(_user$project$View$cssThreatCardCheckboxInput),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$checked(threat.selected),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(selectedMsg),
																	_1: {ctor: '[]'}
																}
															}
														}
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(threat.title),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(_user$project$View$cssThreatCardDescription),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(threat.description),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class(_user$project$View$cssThreatCardSpacer),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
...
var _user$project$View$generateButton = F2(
	function (msg, text) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('GenerateButton'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$View$view = function (m) {
	...
	var subdivs = A2(_elm_lang$core$List$map, _user$project$View$viewThreatCard, viewThreatsList);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('THREAT BANK'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('ThreatTable'),
						_1: {ctor: '[]'}
					},
					subdivs),
				_1: {
...
var _user$project$Main$setid = function (threatList) {
	var threatsId = A2(
		_elm_lang$core$List$filter,
		function (x) {
			return _elm_lang$core$Native_Utils.cmp(x.id, 0) > -1;
		},
		threatList);
	var threatsNoId = A2(
		_elm_lang$core$List$filter,
		function (x) {
			return _elm_lang$core$Native_Utils.cmp(x.id, 0) < 0;
		},
		threatList);
	var maxid = A2(
	...
	var newIds = A2(
		_elm_lang$core$List$range,
		1 + maxid,
		maxid + _elm_lang$core$List$length(threatsNoId));
	var newIdThreats = A3(
		_elm_lang$core$List$map2,
		F2(
			function (a, b) {
...
var _user$project$Main$updateSubThreat = F2(
	function (model, threatresult) {
		var _p0 = function () {
			var _p1 = threatresult;
			if (_p1.ctor === 'Ok') {
				return {ctor: '_Tuple2', _0: _p1._0, _1: 'updated threat'};
			} else {
		...
		var otherthreats = A2(
			_elm_lang$core$List$filter,
			function (x) {
				return !_elm_lang$core$Native_Utils.eq(x.id, threat.id);
			},
			model.threats);
		var newthreats = A2(
			...
			{ctor: '::', _0: threat, _1: otherthreats});
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Main$updateThreat = F3(
	function (threatid, msg, model) {
		...
		if (_p2.ctor === 'Just') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{status: 'no threat by that id'});
		}
	});
var _user$project$Main$validateModel = function (m) {
	var threatIDs = A2(
		_elm_lang$core$List$map,
		function (_) {
			return _.id;
		...
		m.threats);
	var uniqIds = _elm_community$list_extra$List_Extra$allDifferent(threatIDs);
	var filterValidThreats = function (res) {
		var _p3 = res;
		if (_p3.ctor === 'Ok') {
			return false;
		} else {
	...
	var threatsValid = A2(_elm_lang$core$List$map, _user$project$Threat$validateThreat, m.threats);
	var invalidThreats = A2(_elm_lang$core$List$filter, filterValidThreats, threatsValid);
	var lenInvalid = _elm_lang$core$List$length(invalidThreats);
	return (_elm_lang$core$Native_Utils.eq(lenInvalid, 0) && uniqIds) ? _elm_lang$core$Result$Ok(m) : ((!uniqIds) ? _elm_lang$core$Result$Err('Threat IDs not unique') : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(lenInvalid),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' Invalid Threats: ',
				_elm_lang$core$String$concat(
					A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toString, invalidThreats))))));
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			case 'Generate':
				if (_p4._0.ctor === 'CSV') {
					var activeThreats = A2(
						_elm_lang$core$List$filter,
						function (_) {
							return _.selected;
						},
						model.threats);
					var rawpayload = _user$project$Threat$exportThreatsCSV(activeThreats);
					var payload64 = _truqu$elm_base64$Base64$encode(rawpayload);
					var cmd = _elm_lang$navigation$Navigation$load(
						A2(_elm_lang$core$Basics_ops['++'], 'data:application/csv;base64,', payload64));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{status: 'generate CSV file'}),
						_1: cmd
					};
				} else {
					var rawpayload = A2(
						...
						2,
						_user$project$Types$modelEncoder(model));
					var payload64 = _truqu$elm_base64$Base64$encode(rawpayload);
					var cmd = _elm_lang$navigation$Navigation$load(
						A2(_elm_lang$core$Basics_ops['++'], 'data:application/json;base64,', payload64));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{status: 'generate JSON'}),
						_1: cmd
					};
				}
			case 'EditMsg':
			...
			case 'DataReceived':
				if (_p4._0.ctor === 'Ok') {
					var idthreats = _user$project$Main$setid(_p4._0._0);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{threats: idthreats});
					var _p5 = _user$project$Main$validateModel(newModel);
					if (_p5.ctor === 'Ok') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								newModel,
								{status: 'datafetched, loaded.'}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									status: A2(_elm_lang$core$Basics_ops['++'], 'datafetched, but ', _p5._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								status: A2(
									_elm_lang$core$Basics_ops['++'],
									'httperror ',
									_user$project$Rest$createErrorMessage(_p4._0._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
